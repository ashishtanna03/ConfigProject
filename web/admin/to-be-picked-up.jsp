...
<head>
    <title>List of Books To be Picked Up (Admin) - Readers' Hive</title>
                    ...
                    <div id="center_column" class="center_column" style="width:650px;padding: 0 30px 30px 30px;">
                        ...
                        <div class="breadcrumb">
                            <div class="breadcrumb_inner">
                                ...
                                <span class="navigation_page">List of Books To be Picked Up</span></div>
                        </div>
                        <!-- /Breadcrumb -->

                        <div class="inner_a">
                            <h1>List of Books To be Picked Up (Admin)</h1>
                            <hr/>

                            <s:set var="previousPincode" value="%{999999}"/>

                            <s:iterator value="toBePickedUpList" status="iteratorStatus">
                            ...
                            <a href="/admin/orders/PrintPickUpList.action" target="_blank" class="button2">Print List</a>
